...
function setupGround(scene) {
    ...
    terrainMaterial.diffuseTexture1 = new BABYLON.Texture("assets/textures/interior/wood.png", scene);
    terrainMaterial.diffuseTexture2 = terrainMaterial.diffuseTexture1;
    terrainMaterial.diffuseTexture3 = terrainMaterial.diffuseTexture1;
    
    terrainMaterial.diffuseTexture1.uScale = terrainMaterial.diffuseTexture1.vScale = 8;
    terrainMaterial.diffuseTexture2.uScale = terrainMaterial.diffuseTexture2.vScale = 8;
    terrainMaterial.diffuseTexture3.uScale = terrainMaterial.diffuseTexture3.vScale = 8;
    ...
    const ground = BABYLON.MeshBuilder.CreateGroundFromHeightMap("ground", "assets/textures/terrain/hieghtMap.png", {
        ...
        onReady: function(ground) {
            ground.position.y = 80.05;
            ground.position.z = 190.05;
