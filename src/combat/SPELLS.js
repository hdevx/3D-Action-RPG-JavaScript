...
export var SPELLS = {
    ...
    quickSwing: new Spell("Quick Swing", [new Effect("damage", 2)], "fireballAnimation", SlashEffect, 50),
    heavySwing: new Spell("Heavy Swing", [new Effect("damage", 5)], "fireballAnimation", SlashEffect, 70)
}