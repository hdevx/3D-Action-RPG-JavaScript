export function setupWater(scene, ground, engine, player) {
    //use terrain width and height
    var water = BABYLON.MeshBuilder.CreateGround("water", {width: 8000, height: 8000}, scene);
    water.position.y = 12.16;

    var underWaterBackground = BABYLON.MeshBuilder.CreateGround("underwaterBackground", {width: 8000, height: 8000}, scene);
    underWaterBackground.position.y = 1.16;
